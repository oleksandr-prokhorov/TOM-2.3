_HOUSE_XYZ[32] = {-37844.2421875, -1991.2241210938, 22552.29296875, 450};
_HOUSE_XYZ[33] = {-40716.13671875, -1992.7487792969, 20319.7421875, 450};
_HOUSE_XYZ[34] = {-40062.4375, -1973.2155761719, 21805.994140625, 450};
_HOUSE_XYZ[35] = {-39155.875, -1992.0305175781, 23062.884765625, 450};
_HOUSE_XYZ[36] = {-28272.23828125, -1862.8305664063, 27465.728515625, 550};
    ...
    for house = 1, table.getn(_HOUSE_XYZ) do
        if _HOUSE_XYZ[house] ~= nil then
            ...
            if file then
                    ...
                    if l == 1 then
                        ...
                        for slot = 1, table.getn(_HOUSE[house].objects) do
                            if _HOUSE[house].objects[slot][1] == nil then
                                ...
                                if vType == "MOB" then
                                    table.insert(_HOUSE[house].objects[slot], Mob.Create(vobModel, _house_ObjectGetMobname(vobModel), 1, _house_ObjectGetScheme(vobModel), "", "FULLWORLD2.ZEN", x, y, z));
                                    Mob.SetRotation(_HOUSE[house].objects[slot][9], rx, ry, rz)
                                
                                elseif vType == "VOB" then
                                    table.insert(_HOUSE[house].objects[slot], Vob.Create(vobModel, "FULLWORLD2.ZEN", x, y, z));
                ...
                print("("..house..") Owner: ".._HOUSE[house].owner.." / Objects: ".._houseGetValueObjects(house))
            else
...
function _houseVobbing(id)
    ...
    if Player[id].loggedIn == true then
        if GetPlayerWorld(id) == "FULLWORLD2.ZEN" and GetPlayerVirtualWorld(id) == 0 then
...
function _house_DeleteObject(id, sets)
    ...
    if Player[id].loggedIn == true then
        if Player[id]._house_Vobbing == false and Player[id]._house_Editing == false then
            ...
            if cmd == 1 then
                if _HOUSE[house].owner == Player[id].nickname then
...
function _houseAccept(id)
    ...
    if Player[id].loggedIn == true then
        if Player[id]._house_Accept_Object ~= nil and Player[id]._house_Accept == false then
            ...
            Player[id]._house_Vob = Vob.Create(model, "FULLWORLD2.ZEN", x, y + 100, z);
                    ...
                    if _house_ObjectGetType(model) == "VOB" then
                        ...
                        for slot = 1, table.getn(_HOUSE[house].objects) do
                            if _HOUSE[house].objects[slot][1] == nil then
                                ...
                                table.insert(_HOUSE[house].objects[slot], Vob.Create(model, "FULLWORLD2.ZEN", Player[id]._house_VobPos[1], Player[id]._house_VobPos[2], Player[id]._house_VobPos[3]));
                    ...
                    elseif _house_ObjectGetType(model) == "MOB" then
                        ...
                        for slot = 1, table.getn(_HOUSE[house].objects) do
                            if _HOUSE[house].objects[slot][1] == nil then
                                ...
                                table.insert(_HOUSE[house].objects[slot], Player[id]._house_VobRot[2]);
                                table.insert(_HOUSE[house].objects[slot], Player[id]._house_VobRot[3]);
                                table.insert(_HOUSE[house].objects[slot], Mob.Create(model, _house_ObjectGetMobname(model), 1, _house_ObjectGetScheme(model), "", "FULLWORLD2.ZEN", Player[id]._house_VobPos[1], Player[id]._house_VobPos[2], Player[id]._house_VobPos[3]));
