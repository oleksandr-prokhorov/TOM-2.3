...
WARG_DROPLIST_2 = {"ZDPWLA_ITFOMUTTONRAW", "OOLTYB_ITAT_SHADOWFUR"}
WARG_DROPLIST_3 = {"ZDPWLA_ITFOMUTTONRAW", "OOLTYB_ITAT_SHADOWFUR"}
...
GIANT_BUG_DROPLIST_NOSKILL = {"OOLTYB_ITAT_BUGMANDIBLES"}
GIANT_BUG_DROPLIST_1 = {"OOLTYB_ITAT_BUGMANDIBLES", "ZDPWLA_ITFOMUTTONRAW"}
GIANT_BUG_DROPLIST_2 = {"OOLTYB_ITAT_BUGMANDIBLES", "ZDPWLA_ITFOMUTTONRAW"}
GIANT_BUG_DROPLIST_3 = {"OOLTYB_ITAT_BUGMANDIBLES", "ZDPWLA_ITFOMUTTONRAW"}
...
-- params for visual, Y
HUNT_WOLF_PARAMS = {"blyat_syka.3DS", 80} -- MYASO.3DS
HUNT_WARG_PARAMS = {"blyat_syka.3DS", 80}
HUNT_SHADOWBEAST_PARAMS = {"blyat_syka.3DS", 80}
HUNT_TROLL_PARAMS = {"blyat_syka.3DS", 80}
HUNT_BEAR_PARAMS = {"blyat_syka.3DS", 80}
HUNT_KEILER_PARAMS = {"blyat_syka.3DS", 80}
...
function _inst(id) 
	return string.upper(GetPlayerInstance(id)); 
end
...
function _deathMonster(id, killer)
	...
	if _checkNick(id, killer) == false and Player[killer].hunting == true and IsNPC(id) == 1 then
		...
		if _inst(id) == "WOLF" then
			...
			for i = 1, 300 do
				if DROP_POINT[i].status < 1 then
					...
					DROP_POINT[i].world = GetPlayerWorld(id);
		...
		elseif _inst(id) == "GIANT_BUG" then
			...
			for i = 1, 300 do
				if DROP_POINT[i].status < 1 then
					...
					DROP_POINT[i].pos = {x, y, z};
					DROP_POINT[i].world = GetPlayerWorld(id);
					DROP_POINT[i].fromMob = "GIANT_BUG";
					DROP_POINT[i].id = id;
					break
				end
			end
...
function _cmdSkinning(id)
	...
	for i = 1, 300 do
		if DROP_POINT[i].status == 1 then
			...
			if checkPositions < 150 and GetPlayerWorld(id) == DROP_POINT[i].world then
...
function _skinning(id)
	...
	if Player[id].hcurrent_size_h > Player[id].hzero_size_h then
			...
			if Player[id].energy >= HUNTENER_WOLF then
				...
				elseif Player[id].huntlevel == 1 then
					...
					if drop <= 4 then
						...
						CreateItem(WOLF_DROPLIST_1[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 2 then 
					...
					if drop <= 3 then
						...
						DROP_POINT[cell].vob = Vob.Create(HUNT_WOLF_PARAMS[1], WORLD, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]-HUNT_WOLF_PARAMS[2], DROP_POINT[cell].pos[3]);
						Vob.SetCollision(DROP_POINT[cell].vob, 0)
						CreateItem(WOLF_DROPLIST_2[1], 2, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 3 then
					...
					if rnd > 2 then
						...
						DROP_POINT[cell].vob = Vob.Create(HUNT_WOLF_PARAMS[1], WORLD, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]-HUNT_WOLF_PARAMS[2], DROP_POINT[cell].pos[3]);
						Vob.SetCollision(DROP_POINT[cell].vob, 0)
						CreateItem(WOLF_DROPLIST_3[1], 3, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
			...
			if Player[id].energy >= HUNTENER_SCAVENGER then
				...
				elseif Player[id].huntlevel == 1 then
					...
					if drop <= 4 then
						...
						CreateItem(SCAVENGER_DROPLIST_1[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 2 then 
					...
					if drop <= 3 then
						...
						CreateItem(SCAVENGER_DROPLIST_2[1], 2, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 3 then
					...
					if rnd > 2 then
						...
						UpdateEnergyBar(id);
						_saveEnergy(id);
						CreateItem(SCAVENGER_DROPLIST_3[1], 3, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
			...
			if Player[id].energy >= HUNTENER_WARG then
				...
				elseif Player[id].huntlevel == 1 then
					...
					if drop <= 4 then
						...
						Vob.SetCollision(DROP_POINT[cell].vob, 0)
						CreateItem(WARG_DROPLIST_1[1], 2, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
						GameTextForPlayer(id, 50, 6000, "Вы разделали тушу варга","Font_Old_10_White_Hi.TGA", 218,165,32, 3000);
					end
					SavePlayer(id);
				...
				elseif Player[id].huntlevel == 2 then 
					...
					if drop <= 3 then
						...
						DROP_POINT[cell].vob = Vob.Create(HUNT_WARG_PARAMS[1], WORLD, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]-HUNT_WARG_PARAMS[2], DROP_POINT[cell].pos[3]);
						Vob.SetCollision(DROP_POINT[cell].vob, 0)
						CreateItem(WARG_DROPLIST_2[1], 2, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 3 then
					...
					if rnd > 2 then
						...
						DROP_POINT[cell].vob = Vob.Create(HUNT_WARG_PARAMS[1], WORLD, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]-HUNT_WARG_PARAMS[2], DROP_POINT[cell].pos[3]);
						Vob.SetCollision(DROP_POINT[cell].vob, 0)
						CreateItem(WARG_DROPLIST_3[1], 3, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
			...
			if Player[id].energy >= HUNTENER_TROLL then
				...
				if Player[id].huntlevel == 0 then
					...
					if drop == 1 then
						...
						CreateItem(TROLL_DROPLIST_NOSKILL[1], 5, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 1 then
					...
					if drop <= 4 then
						...
						Vob.SetCollision(DROP_POINT[cell].vob, 0)
						CreateItem(TROLL_DROPLIST_1[1], 8, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
						GameTextForPlayer(id, 50, 6000, "Вы разделали тушу тролля","Font_Old_10_White_Hi.TGA", 218,165,32, 3000);
					end
					SavePlayer(id);
				...
				elseif Player[id].huntlevel == 2 then 
					...
					if drop <= 3 then
						...
						DROP_POINT[cell].vob = Vob.Create(HUNT_TROLL_PARAMS[1], WORLD, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]-HUNT_TROLL_PARAMS[2], DROP_POINT[cell].pos[3]);
						Vob.SetCollision(DROP_POINT[cell].vob, 0)
						CreateItem(TROLL_DROPLIST_2[1], 12, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)	
						GameTextForPlayer(id, 50, 6000, "Вы разделали тушу тролля","Font_Old_10_White_Hi.TGA", 218,165,32, 3000);
					end
					SavePlayer(id);
					Player[id].huntexp = Player[id].huntexp + HUNTEXP_TROLL;
				...
				elseif Player[id].huntlevel == 3 then
					...
					DROP_POINT[cell].vob = Vob.Create(HUNT_TROLL_PARAMS[1], WORLD, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]-HUNT_TROLL_PARAMS[2], DROP_POINT[cell].pos[3]);
					Vob.SetCollision(DROP_POINT[cell].vob, 0)
					CreateItem(TROLL_DROPLIST_3[1], 15, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
			...
			if Player[id].energy >= HUNTENER_MOLERAT then
				...
				if Player[id].huntlevel == 0 then
					...
					if drop == 1 then
						...
						CreateItem(MOLERAT_DROPLIST_NOSKILL[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 1 then
					...
					if drop <= 4 then
						...
						CreateItem(MOLERAT_DROPLIST_1[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 2 then 
					...
					if drop <= 3 then
						...
						CreateItem(MOLERAT_DROPLIST_2[1], 2, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 3 then
					...
					if rnd > 2 then
						...
						UpdateEnergyBar(id);
						_saveEnergy(id);
						CreateItem(MOLERAT_DROPLIST_3[1], 3, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
			...
			if Player[id].energy >= HUNTENER_KEILER then
				...
				if Player[id].huntlevel == 0 then
					...
					if drop == 1 then
						...
						CreateItem(KEILER_DROPLIST_NOSKILL[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 1 then
					...
					if drop <= 4 then
						...
						Vob.SetCollision(DROP_POINT[cell].vob, 0)
						CreateItem(KEILER_DROPLIST_1[1], 2, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 2 then 
					...
					if drop <= 3 then
						...
						DROP_POINT[cell].vob = Vob.Create(HUNT_KEILER_PARAMS[1], WORLD, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]-HUNT_KEILER_PARAMS[2], DROP_POINT[cell].pos[3]);
						Vob.SetCollision(DROP_POINT[cell].vob, 0)
						CreateItem(KEILER_DROPLIST_2[1], 3, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 3 then
					...
					if rnd > 2 then
						...
						DROP_POINT[cell].vob = Vob.Create(HUNT_KEILER_PARAMS[1], WORLD, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]-HUNT_KEILER_PARAMS[2], DROP_POINT[cell].pos[3]);
						Vob.SetCollision(DROP_POINT[cell].vob, 0)
						CreateItem(KEILER_DROPLIST_3[1], 4, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
		...
		elseif DROP_POINT[cell].fromMob == "SNAPPER" then
			if Player[id].energy >= HUNTENER_SNAPPER then
				...
				if Player[id].huntlevel == 0 then
					...
					if drop == 1 then
						...
						CreateItem(SNAPPER_DROPLIST_NOSKILL[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 1 then
					...
					if drop <= 4 then
						...
						CreateItem(SNAPPER_DROPLIST_1[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 2 then 
					...
					if drop <= 3 then
						...
						CreateItem(SNAPPER_DROPLIST_2[1], 2, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 3 then
					...
					if rnd > 2 then
						...
						UpdateEnergyBar(id);
						_saveEnergy(id);
						CreateItem(SNAPPER_DROPLIST_3[1], 3, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
			...
			elseif DROP_POINT[cell].fromMob == "GIANT_BUG" then
			if Player[id].energy >= HUNTENER_GIANT_BUG then

				if Player[id].huntlevel == 0 then
					Player[id].energy = Player[id].energy - HUNTENER_GIANT_BUG;
					UpdateEnergyBar(id);
					_saveEnergy(id);
					SavePlayer(id);
					LogHunt(id, "GIANT_BUG", false, 0);
					GameTextForPlayer(id, 50, 6000, "Вы не смогли освежевать тушу","Font_Old_10_White_Hi.TGA", 255, 0, 0, 3000);
				...
				elseif Player[id].huntlevel == 1 then
					...
					GameTextForPlayer(id, 50, 6000, "Вы не смогли освежевать тушу","Font_Old_10_White_Hi.TGA", 255,0,0, 3000);
					SavePlayer(id);
					Player[id].huntexp = Player[id].huntexp + HUNTEXP_GIANT_BUG;
					UpdateHuntLevel(id);
					SaveHunt(id);
				...
				elseif Player[id].huntlevel == 2 then 
					...
					if drop <= 3 then
						...
						CreateItem(GIANT_BUG_DROPLIST_2[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
					...
					UpdateHuntLevel(id);
					SaveHunt(id);
					LogHunt(id, "GIANT_BUG", true, HUNTEXP_GIANT_BUG, GIANT_BUG_DROPLIST_2[1], GIANT_BUG_DROPLIST_2[2]);
				...
				elseif Player[id].huntlevel == 3 then
					...
					if rnd > 2 then
						...
						UpdateEnergyBar(id);
						_saveEnergy(id);
						CreateItem(GIANT_BUG_DROPLIST_3[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
						CreateItem(GIANT_BUG_DROPLIST_3[2], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
						GameTextForPlayer(id, 50, 6000, "Вы разделали тушу ползуна","Font_Old_10_White_Hi.TGA", 218,165,32, 3000);
						SavePlayer(id);
						LogHunt(id, "GIANT_BUG", true, 0, GIANT_BUG_DROPLIST_3[1], GIANT_BUG_DROPLIST_3[2], GIANT_BUG_DROPLIST_3[3]);
					else
						GameTextForPlayer(id, 50, 6000, "Вы не смогли освежевать тушу","Font_Old_10_White_Hi.TGA", 255,0,0, 3000);
						Player[id].energy = Player[id].energy - HUNTENER_GIANT_BUG;
						UpdateEnergyBar(id);
			...
			if Player[id].energy >= HUNTENER_SHADOWBEAST then
				...
				if Player[id].huntlevel == 0 then
					...
					if drop == 1 then
						...
						CreateItem(SHADOWBEAST_DROPLIST_NOSKILL[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 1 then
					...
					if drop <= 4 then
						...
						Vob.SetCollision(DROP_POINT[cell].vob, 0)
						CreateItem(SHADOWBEAST_DROPLIST_1[1], 2, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
						GameTextForPlayer(id, 50, 6000, "Вы разделали тушу мракориса","Font_Old_10_White_Hi.TGA", 218,165,32, 3000);
					end
					SavePlayer(id);
				...
				elseif Player[id].huntlevel == 2 then 
					...
					if drop <= 3 then
						...
						DROP_POINT[cell].vob = Vob.Create(HUNT_SHADOWBEAST_PARAMS[1], WORLD, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]-HUNT_SHADOWBEAST_PARAMS[2], DROP_POINT[cell].pos[3]);
						Vob.SetCollision(DROP_POINT[cell].vob, 0)
						CreateItem(SHADOWBEAST_DROPLIST_2[1], 3, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 3 then
					...
					DROP_POINT[cell].vob = Vob.Create(HUNT_SHADOWBEAST_PARAMS[1], WORLD, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]-HUNT_SHADOWBEAST_PARAMS[2], DROP_POINT[cell].pos[3]);
					Vob.SetCollision(DROP_POINT[cell].vob, 0)
					CreateItem(SHADOWBEAST_DROPLIST_3[1], 4, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
			...
			if Player[id].energy >= HUNTENER_WARAN then
				...
				if Player[id].huntlevel == 0 then
					...
					if drop == 1 then
						...
						CreateItem(WARAN_DROPLIST_NOSKILL[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 1 then
					...
					if drop <= 4 then
						...
						CreateItem(WARAN_DROPLIST_1[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 2 then 
					...
					if drop <= 3 then
						...
						CreateItem(WARAN_DROPLIST_2[1], 2, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 3 then
					...
					if rnd > 2 then
						...
						UpdateEnergyBar(id);
						_saveEnergy(id);
						CreateItem(WARAN_DROPLIST_3[1], 3, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
			...
			if Player[id].energy >= HUNTENER_GIANT_RAT then
				...
				if Player[id].huntlevel == 0 then
					...
					if drop == 1 then
						...
						CreateItem(GIANT_RAT_DROPLIST_NOSKILL[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 1 then
					...
					if drop <= 4 then
						...
						CreateItem(GIANT_RAT_DROPLIST_1[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
						GameTextForPlayer(id, 50, 6000, "Вы разделали тушу крысы","Font_Old_10_White_Hi.TGA", 218,165,32, 3000);
					end
					SavePlayer(id);
				...
				elseif Player[id].huntlevel == 2 then 
					...
					if drop <= 3 then
						...
						CreateItem(GIANT_RAT_DROPLIST_2[1], 2, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
						GameTextForPlayer(id, 50, 6000, "Вы разделали тушу крысы","Font_Old_10_White_Hi.TGA", 218,165,32, 3000);
					end
					SavePlayer(id);
					Player[id].huntexp = Player[id].huntexp + HUNTEXP_GIANT_RAT;
				...
				elseif Player[id].huntlevel == 3 then
					...
					if rnd > 2 then
						...
						UpdateEnergyBar(id);
						_saveEnergy(id);
						CreateItem(GIANT_RAT_DROPLIST_3[1], 3, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
						GameTextForPlayer(id, 50, 6000, "Вы разделали тушу крысы","Font_Old_10_White_Hi.TGA", 218,165,32, 3000);
						SavePlayer(id);
			...
			if Player[id].energy >= HUNTENER_LURKER then
				...
				if Player[id].huntlevel == 0 then
					...
					if drop == 1 then
						...
						CreateItem(LURKER_DROPLIST_NOSKILL[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 1 then
					...
					if drop <= 4 then
						...
						CreateItem(LURKER_DROPLIST_1[1], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
						CreateItem(LURKER_DROPLIST_1[2], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 2 then 
					...
					if drop <= 3 then
						...
						CreateItem(LURKER_DROPLIST_2[1], 2, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
						CreateItem(LURKER_DROPLIST_2[2], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
				...
				elseif Player[id].huntlevel == 3 then
					...
					if rnd > 2 then
						...
						UpdateEnergyBar(id);
						_saveEnergy(id);
						CreateItem(LURKER_DROPLIST_3[1], 3, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
						CreateItem(LURKER_DROPLIST_3[2], 1, DROP_POINT[cell].pos[1], DROP_POINT[cell].pos[2]+100, DROP_POINT[cell].pos[3], WORLD, 0, 0, 0, 1)
