...
local sound_id9 = CreateSound("CS_IAI_ME_ME_09.WAV")
local sound_id8 = CreateSound("CS_IAI_ME_ME_08.WAV")
local sound_id7 = CreateSound("CS_IAI_ME_ME_07.WAV")
local sound_id6 = CreateSound("CS_IAI_ME_ME_06.WAV")
local sound_id5 = CreateSound("CS_IAI_ME_ME_05.WAV")
local sound_id4 = CreateSound("CS_IAI_ME_ME_04.WAV")
local sound_id3 = CreateSound("CS_IAI_ME_ME_03.WAV")
local sound_id2 = CreateSound("CS_IAI_ME_ME_02.WAV")
local sound_id = CreateSound("CS_IAI_ME_ME_01.WAV")
